...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!recaptchaSiteKey) {
      toast.error("reCAPTCHA is not configured. Add VITE_RECAPTCHA_SITE_KEY to continue.", {
        duration: 3500,
      ...
      >
        <div className="flex justify-between items-center mb-4">
          ...
          >
            ...
            <span className="font-medium">+92 321 8855417</span>
          </a>
        </div>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Hey Hamza, love the website! I'd like to chat about some opportunities you might like! 🎉"
          ...
          <div className="flex justify-center">
            <div className="rounded-lg overflow-hidden shadow-lg">
              {recaptchaSiteKey ? (
                ...
                <p className="text-sm text-amber-300 px-3 py-2 text-center">
